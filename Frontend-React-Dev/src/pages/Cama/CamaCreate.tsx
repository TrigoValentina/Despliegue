...
const CamaCreate = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_BASE_URL}/cama`, { 
        datosCama: camaData, 
        datosHistorial: historialData 
      });

      console.log('Cama creada:', response.data);
      setSuccessMessage('Cama creada correctamente');
      ...
      <div className="container form-container" style={{ 
        ...
        <form onSubmit={handleSubmit} style={{ 
          ...
          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label htmlFor="instalada" style={{ fontWeight: 'bold', color: '#555' }}>
              Instalada:
            </label>
            <input
              type="number"
          ...
          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label htmlFor="ofertada" style={{ fontWeight: 'bold', color: '#555' }}>
              Ofertada:
            </label>
            <input
              type="number"
          ...
          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label htmlFor="disponible" style={{ fontWeight: 'bold', color: '#555' }}>
              Disponible:
            </label>
            <input
              type="number"
          ...
          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label htmlFor="ocupada" style={{ fontWeight: 'bold', color: '#555' }}>
              Ocupada:
            </label>
            <input
              type="number"
          ...
          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label htmlFor="alta" style={{ fontWeight: 'bold', color: '#555' }}>
              Alta:
            </label>
            <input
              type="number"
              ...
              onChange={handleChange}
              className="form-control"
              placeholder="Número de camas de alta"
              min="0"
            />
          </div>

          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label htmlFor="especialidad" style={{ fontWeight: 'bold', color: '#555' }}>
              Especialidad:
            </label>
            <select
              id="especialidad"
          ...
          <div className="form-group" style={{ marginBottom: '15px' }}>
            <label htmlFor="servicio" style={{ fontWeight: 'bold', color: '#555' }}>
              Servicio:
            </label>
            <select
              id="servicio"
